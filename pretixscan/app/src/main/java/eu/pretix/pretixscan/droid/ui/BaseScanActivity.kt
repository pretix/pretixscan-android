...
abstract class BaseScanActivity : AppCompatActivity(), ReloadableActivity, ScannerView.ResultHandler, MediaPlayer.OnCompletionListener,
    ConnectivityChangedListener, NfcHandler.OnChipReadListener {
    ...
    var nfcHandler: NfcHandler? = null
